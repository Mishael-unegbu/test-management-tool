...
const USER_STORIES_COLUMNS = [
  'StoryID', 'ProjectID', 'Title', 'Description',
  'AcceptanceCriteria', 'Priority', 'Status', 'CreatedBy',
  'CreatedDate', 'UpdatedDate',
];

const TEST_CASES_COLUMNS = [
  'TestCaseID', 'StoryID', 'ProjectID', 'Title', 'Description',
  'Preconditions', 'TestSteps', 'ExpectedResult', 'Priority', 'Status',
  'CreatedDate', 'UpdatedDate',
];

const AUDIT_LOG_COLUMNS = [
  'AuditID', 'EntityType', 'EntityID', 'Action',
  'ChangedField', 'OldValue', 'NewValue', 'ChangeDate',
];
...
async function createTestWorkbook() {
  ...
  const testCases = workbook.addWorksheet('TestCases');
  testCases.addRow(TEST_CASES_COLUMNS);
