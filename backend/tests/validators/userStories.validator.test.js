...
describe('validateEditUserStoryPayload (US-006)', () => {
  ...
  it('rejects attempts to modify StoryID or CreatedBy', () => {
    const { valid, errors } = validateEditUserStoryPayload(
      { StoryID: 1, CreatedBy: 'Someone Else' },
      allowedPriorities,
      allowedStatuses
    );
    expect(valid).toBe(false);
